      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 md:mt-16 bg-primary-50 p-8 rounded-lg border border-primary-100">
          <div className="text-center">
            ...
            <p className="text-gray-700 font-inter mb-6">Mais de 500 pacientes alcançaram suas metas com nossos protocolos personalizados</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-3xl font-bold text-primary-600 font-montserrat">93%</p>
                <p className="text-sm text-gray-700 font-inter">Taxa de sucesso</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-3xl font-bold text-primary-600 font-montserrat">+40%</p>
                <p className="text-sm text-gray-700 font-inter">Aumento na performance</p>
              </div>
            </div>
          </div>
        </div>
