      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-8">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-300 max-w-xs font-inter">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="mailto:contato@nutriboost.com.br" className="text-gray-300 hover:text-accent transition-colors">
                <Mail className="h-5 w-5" />
              </a>
              <a href="https://wa.me/5511987654321" className="text-gray-300 hover:text-accent transition-colors">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 font-inter">
                ...
                <li>
                  <button onClick={() => scrollToSection("resultados")} className="text-gray-300 hover:text-white transition-colors">
                    Resultados
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection("depoimentos")} className="text-gray-300 hover:text-white transition-colors">
                    Depoimentos
                  </button>
                </li>
              </ul>
